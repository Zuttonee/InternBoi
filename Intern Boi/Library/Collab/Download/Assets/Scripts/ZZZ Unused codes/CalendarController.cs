...
{
    public GameObject _calendarPanel; // whole calender
    public Text _yearNumText;
    public Text _monthNumText;

    public GameObject _item; // start position

    public List<GameObject> _dateItems = new List<GameObject>();
    const int _totalDateNum = 42; // amount of date blocks
    ...
    void Start()
    {
        ...
        _calendarPanel.SetActive(false); //disable calender
    }
    ...
    {
        _calendarPanel.SetActive(true); // show calender when icon pressed
        _target = target;
        //Spawn calender at the center of the screen??
